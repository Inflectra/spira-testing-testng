    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.inflectra.spiratest.addons.testnglistener.soap.ImportExport.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.inflectra.spiratest.addons.testnglistener.soap.ImportExport.class.getResource(".");
